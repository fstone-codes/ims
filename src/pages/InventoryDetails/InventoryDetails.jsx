...
function InventoryDetails() {
    ...
    async function getSingleItemData() {
        try {
            ...
            console.error(
                "Error fetching single inventory item details: ",
                error
            );
        }
    }
        ...
        <main className="main-inv">
            <section className="title-inv">
                <div className="title-inv__container">
                    ...
                    <h1 className="title-inv__header">
                        {singleItem.item_name}
                    </h1>
                </div>
                <Link
                    className="title-inv__icon-container"
                    to={`/inventory/${inventoryId}/edit`}
                >
                    <img
                        className="title-inv__edit-icon"
                        src={editWhiteIcon}
                        alt="edit icon"
                    />
            ...
            <section className="inv-details">
                <div className="inv-details__container inv-details__container--top-left">
                    <div className="inv-details__content-container">
                        <h2 className="inv-details__label">
                            ITEM DESCRIPTION:
                        </h2>
